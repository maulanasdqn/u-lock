...
export const Button: FC<TButton> = ({
  ...
  const className = clsx(
    ...
    {
      "text-white border border-2 disabled:border-gray-300 border-sky-700 bg-sky-700 hover:bg-sky-800 focus:ring-sky-300 ":
        variant === "primary",
      "text-gray-700 border border-2 border-sky-700 text-sky-700 bg-transparent hover:opacity-90 focus:ring-gray-700":
        variant === "secondary",
    }
  );
  return (
